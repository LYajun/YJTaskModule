...
/**
 * Creates an `YJSpeechTimer` object and schedules it to start ticking inmediately.
 */
 ...
 * @note `YJSpeechTimer` won't invoke the `selector` on `target` again after calling this method.
