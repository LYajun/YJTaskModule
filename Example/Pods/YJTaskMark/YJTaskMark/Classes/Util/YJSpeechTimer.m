...
#import <libkern/OSAtomic.h>
    ...
    #error YJSpeechTimer is ARC only. Either turn on ARC for the project or use -fobjc-arc flag
#endif
             ...
             dispatchQueue:(dispatch_queue_t)dispatchQueue
{
    ...
    if ((self = [super init]))
    {
        ...
        NSString *privateQueueName = [NSString stringWithFormat:@"com.mindsnacks.YJSpeechTimer.%p", self];
...
+ (instancetype)scheduledTimerWithTimeInterval:(NSTimeInterval)timeInterval
                                 ...
                                 dispatchQueue:(dispatch_queue_t)dispatchQueue
{
    YJSpeechTimer *timer = [[self alloc] initWithTimeInterval:timeInterval
                                                     target:target
                                                   selector:selector
                                                   userInfo:userInfo
                                                    repeats:repeats
...
- (void)schedule
{
    ...
    __weak YJSpeechTimer *weakSelf = self;
