...
#pragma mark - YJProgressLayer

@interface YJProgressLayer : CALayer
...
@implementation YJProgressLayer {
...
#pragma mark - YJProgressView

@implementation YJProgressView

+ (Class)layerClass {
    return [YJProgressLayer class];
}
...
- (void)setProgress:(float)progress animated:(BOOL)animated {
    ...
    YJProgressLayer *layer = (YJProgressLayer *)self.layer;
    layer.progress = _progress;
    [(YJProgressLayer *)self.layer setProgressWithAnimated:animated];
}
