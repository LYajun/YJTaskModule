...
{
    return [[YJFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[YJFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[YJFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[YJFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[YJFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[YJFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
